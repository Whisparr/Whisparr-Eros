...
| --- | --- | --- |
| Files importing `react-redux` | 327 of 1,255 | **201** of 1,226 |
| Lines under `frontend/src/Store/` | 15,374 across 138 files | **9,144** across 98 |
| Redux slices registered in `Store/Actions/index.js` | 35 | **12** |
| Remaining `*Connector` files | 66 | **54** |
| Files touching React Query | 35 | **66** |
| zustand stores | 0 (not installed) | **installed, 22 files** |
