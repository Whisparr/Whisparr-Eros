...
| Lines under `frontend/src/Store/` | 15,374 across 138 files | **6,175** across 84 |
| Redux slices registered in `Store/Actions/index.js` | 35 | **4** |
| Remaining `*Connector` files | 66 | **44** |
| Files touching React Query | 35 | **70** |
| zustand stores | 0 (not installed) | **installed, 32 files** |
...
and the app shell. **Phase D is well under way** — Scene, Performer, Studio, Collection and
interactive import, interactive search and movie files/credits are done; Movie is
part-done; Add/Import Movie remains. It is a step up again: a domain index page sits on top of all
