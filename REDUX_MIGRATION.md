...
| --- | --- | --- |
| Files importing `react-redux` | 327 of 1,255 | **72** of 1,182 |
| Lines under `frontend/src/Store/` | 15,374 across 138 files | **3,994** across 55 |
...
Everything still importing `react-redux` is now Settings (57 files), plus twelve
...
| 7 | **Indexers · Indexer Options · Indexer Flags** (11 files, three commits). Split three ways, as Sonarr did. ~~Indexer Flags~~ **done, #536** — a read-only list, the Languages shape again, and it took the last `react-redux` import out of `Movie/`. Indexers and Indexer Options remain. | `Settings/indexers.js`, `Settings/indexerOptions.js`, `IndexerFilterBuilderRowValueConnector.js`; ~~`Settings/indexerFlags.js`, `createIndexerFlagsSelector.ts`, `IndexerFlagSettingsAppState`~~ | [Sonarr/Sonarr@c4c0ec25](https://github.com/Sonarr/Sonarr/commit/c4c0ec25), [Sonarr/Sonarr@7a455dd0](https://github.com/Sonarr/Sonarr/commit/7a455dd0), [Sonarr/Sonarr@fbb70519](https://github.com/Sonarr/Sonarr/commit/fbb70519) |
...
- Delete `frontend/src/Store/` — 57 files, 4,052 lines today, from 138 files and 15,374
  lines at assessment.
...
**Next: section 7b** — Indexer Options, the single-object form, then **7c** — Indexers,
the provider list. 7c is the one that carries `IndexerFilterBuilderRowValueConnector.js`
and the bulk-edit manage modal, so it is the larger half by some distance.
