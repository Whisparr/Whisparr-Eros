...
| --- | --- | --- |
| Files importing `react-redux` | 327 of 1,255 | **183** of 1,219 |
| Lines under `frontend/src/Store/` | 15,374 across 138 files | **7,990** across 92 |
| Redux slices registered in `Store/Actions/index.js` | 35 | **9** |
| Remaining `*Connector` files | 66 | **53** |
| Files touching React Query | 35 | **67** |
| zustand stores | 0 (not installed) | **installed, 26 files** |
