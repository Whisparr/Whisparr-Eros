...
| --- | --- | --- |
| Files importing `react-redux` | 327 of 1,255 | **161** of 1,212 |
| Lines under `frontend/src/Store/` | 15,374 across 138 files | **6,963** across 87 |
| Redux slices registered in `Store/Actions/index.js` | 35 | **7** |
| Remaining `*Connector` files | 66 | **46** |
| Files touching React Query | 35 | **69** |
| zustand stores | 0 (not installed) | **installed, 30 files** |
...
interactive import are done; Movie is part-done; interactive search, movie files/credits
