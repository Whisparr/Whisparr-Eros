...
- **46 `.js` files are still unchecked** — down from 114. The follow-on this thread asked
  ...
  `dragTypes`. What is left, in the order it is queued: `Styles/Themes` (3), the one-off
  components (16, mostly PropTypes → `Readonly<Props>`), the filter builder (8, two
