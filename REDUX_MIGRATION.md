...
| --- | --- | --- |
| Files importing `react-redux` | 327 of 1,255 | **151** of 1,207 |
| Lines under `frontend/src/Store/` | 15,374 across 138 files | **5,879** across 82 |
| Redux slices registered in `Store/Actions/index.js` | 35 | **3** |
| Remaining `*Connector` files | 66 | **43** |
| Files touching React Query | 35 | **70** |
| zustand stores | 0 (not installed) | **installed, 35 files** |
