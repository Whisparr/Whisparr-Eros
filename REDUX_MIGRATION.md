...
| --- | --- | --- |
| Files importing `react-redux` | 327 of 1,255 | **158** of 1,213 |
| Lines under `frontend/src/Store/` | 15,374 across 138 files | **6,597** across 86 |
| Redux slices registered in `Store/Actions/index.js` | 35 | **6** |
| Remaining `*Connector` files | 66 | **46** |
| Files touching React Query | 35 | **70** |
| zustand stores | 0 (not installed) | **installed, 31 files** |
...
interactive import and interactive search are done; Movie is part-done; movie
files/credits and Add/Import Movie remain. It is a step up again: a domain index page sits on top of all
