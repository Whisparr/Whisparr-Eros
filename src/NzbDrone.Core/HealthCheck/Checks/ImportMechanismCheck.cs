...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class ImportMechanismCheck : HealthCheckBase
    {
        ...
        public override HealthCheck Check()
        {
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Warning, HealthCheckReason.ImportMechanismHandlingDisabled, _localizationService.GetLocalizedString("ImportMechanismHealthCheckMessage"), "#completed-download-handling-is-disabled");
            }
