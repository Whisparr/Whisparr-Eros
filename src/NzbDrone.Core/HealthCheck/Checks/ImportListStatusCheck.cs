...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class ImportListStatusCheck : HealthCheckBase
    {
        ...
        public override HealthCheck Check()
        {
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Error, HealthCheckReason.ImportListStatusAllUnavailable, _localizationService.GetLocalizedString("ImportListStatusCheckAllClientMessage"), "#lists-are-unavailable-due-to-failures");
            }
