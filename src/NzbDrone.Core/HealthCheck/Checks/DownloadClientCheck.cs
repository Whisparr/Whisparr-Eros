...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class DownloadClientCheck : HealthCheckBase
    {
        ...
        public override HealthCheck Check()
        {
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Warning, HealthCheckReason.DownloadClientCheckNoneAvailable, _localizationService.GetLocalizedString("DownloadClientCheckNoneAvailableMessage"), "#no-download-client-is-available");
            }
