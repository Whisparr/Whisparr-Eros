...
namespace NzbDrone.Core.HealthCheck.Checks
{
    ...
    public class DownloadClientStatusCheck : HealthCheckBase
    {
        ...
        public override HealthCheck Check()
        {
            ...
            {
                return new HealthCheck(GetType(), HealthCheckResult.Error, HealthCheckReason.DownloadClientStatusAllClients, _localizationService.GetLocalizedString("DownloadClientStatusCheckAllClientMessage"), "#download-clients-are-unavailable-due-to-failures");
            }
