...
interface StudioDetailsPosterOptionsModalProps {
  isOpen: boolean;
  onModalClose(...args: unknown[]): unknown;
}

function StudioDetailsPosterOptionsModal({
  isOpen,
  onModalClose,
}: StudioDetailsPosterOptionsModalProps) {
...
export default StudioDetailsPosterOptionsModal;
