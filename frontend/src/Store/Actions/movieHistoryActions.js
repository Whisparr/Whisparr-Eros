...
export const MOVIE_HISTORY_MARK_AS_FAILED =
  'movieHistory/movieHistoryMarkAsFailed';
...
export const movieHistoryMarkAsFailed = createThunk(
  MOVIE_HISTORY_MARK_AS_FAILED
);
...
export const actionHandlers = handleThunks({
  ...
  [MOVIE_HISTORY_MARK_AS_FAILED]: function (getState, payload, dispatch) {
    const { historyId, movieId } = payload;
