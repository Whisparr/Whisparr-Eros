...
export const SET_UNMAPPED_MOVIE_FILES_SORT =
  'unmappedMovieFiles/setUnmappedMovieFilesSort';
export const SET_UNMAPPED_MOVIE_FILES_TABLE_OPTION =
  'unmappedMovieFiles/setUnmappedMovieMovieFilesTableOption';

//
// Action Creators

export const setUnmappedMovieFilesSort = createAction(
  SET_UNMAPPED_MOVIE_FILES_SORT
);
export const setUnmappedMovieFilesTableOption = createAction(
  SET_UNMAPPED_MOVIE_FILES_TABLE_OPTION
);
