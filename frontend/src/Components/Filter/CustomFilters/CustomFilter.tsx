...
function CustomFilter({
  ...
  useEffect(() => {
    return () => {
      // Assume that delete and then unmounting means the deletion was
      // successful. Moving this check to an ancestor would be more accurate,
      // but would have more boilerplate.
      if (isDeletingInternal && id === selectedFilterKey) {
        dispatchSetFilter({ selectedFilterKey: 'all' });
      }
    };
  }, [id, isDeletingInternal, selectedFilterKey, dispatchSetFilter]);
